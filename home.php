    ...
    <div class="workshop__body container">
        ...
        <div class="workshop__content workshop__content--right">
            <div class="workshop__item workshop__item--pos">
                ...
                <div class="workshop__pic">
                    <img src="<?php echo STANDART_DIR; ?>img/workshop/main-workshop-photo-4.jpg" alt="" class="workshop__photo">
                </div>
            </div>
            <div class="workshop__item workshop__item--pos">
                <div class="workshop__content-action workshop__content-action--main gs-reveal gs-reveal--from-right">
                    <a href="./page-authors.html" class="button button--yellow">
                        Художники
                    </a>
                </div>
                <div class="workshop__pic gs-reveal gs-reveal--from-right">
