...
function init() {
  ...
  window.addEventListener('mousemove', function (e) {
    _gsap.default.to(cur, 0.2, {
      x: e.clientX,
      y: e.clientY
    });

    _gsap.default.to(follow, 0.9, {
      x: e.clientX,
      y: e.clientY
    });
  });
...
},{"gsap":3}],98:[function(require,module,exports){
"use strict";
...
},{"gsap":3,"gsap/ScrollTrigger":2}],99:[function(require,module,exports){
"use strict";
...
},{"gsap":3}],100:[function(require,module,exports){
"use strict";
...
function init() {
  fetch('https://ig.instant-tokens.com/users/bc4339ba-6e2d-4a4b-bfe1-dcbf8efaec6a/instagram/17841407146434748/token?userSecret=wsvfhvo068jqtr51qqtie').then(function (resp) {
    return resp.json();
  }).then(function (data) {
...
},{"instafeed.js":4}],101:[function(require,module,exports){
"use strict";
...
},{"gsap":3}],103:[function(require,module,exports){
"use strict";
...
var _cursor = _interopRequireDefault(require("../libs/modules/cursor.js"));
...
var _instafeed = _interopRequireDefault(require("../libs/modules/instafeed.js"));

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

document.addEventListener('DOMContentLoaded', function (e) {
  var instafeedTrue = document.querySelector('#instafeed');

  _gsap.default.config({
    nullTargetWarn: false
  });

  _cursor.default.init();
  ...
  instafeedTrue ? _instafeed.default.init() : false;
});
