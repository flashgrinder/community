...
function init() {
  ...
  tl.fromTo(firstWords, {
    ...
    clipPath: 'polygon(-10% 110%, 110% 110%, 110% -10%, -10%  -10%)',
    y: 0
  }, 0.2) // .from(header, {y: '-100%', duration: 0.4})
  .from(indexSlider, {
    opacity: 0,
    duration: 0.6
  }, '-=0.4').to(indexLetters, {
...
},{"swiper":93}],105:[function(require,module,exports){
"use strict";
...
var _animationHeader = _interopRequireDefault(require("./modules/animationHeader.js"));

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

document.addEventListener('DOMContentLoaded', function (e) {
  var indexAnimationTrue = document.querySelector('.js-index-slider');
  ...
  _animationHeader.default.init();

  indexAnimationTrue ? _indexAnimation.default.init() : false;
});
